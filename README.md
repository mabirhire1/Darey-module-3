...
In this mini project you will create modularized Terraform configurations for deploying an EC2 instance with a Security Group and Apache2 web server using UserData scripts.
...
```
**Output**
"http://ec2-52-55-181-213.compute-1.amazonaws.com"

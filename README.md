...
**Tasks:**
1. Create public subnets in 2 AZs for internet-facing resources
2. Create private subnets in 2 AZs for application and database tiers
3. Deploy NAT Gateway in public subnet for outbound internet access
4. Configure route tables with appropriate associations
...
**Tasks:**
1. Create RDS subnet group across private subnets
2. Deploy MySQL RDS instance with Multi-AZ configuration
...
2. Create EFS mount targets in each AZ
3. Configure EFS security group for NFS access
...
2. Configure target group for EC2 instances
3. Set up health checks for WordPress application
4. Configure listener rules for HTTP/HTTPS traffic
...
**Tasks:**
1. Create launch template with WordPress AMI
2. Configure Auto Scaling Group across multiple AZs
3. Set up scaling policies based on CPU utilization
4. Integrate Application Load Balancer

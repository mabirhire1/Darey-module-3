...
If Docker is not already installed, follow the official installation guide [here](https://docs.docker.com/get-started/get-docker/)
...
endpoints:
  ...
  - name: docker-hub
    ...
    conditions:
      - "[STATUS] == 200"   
```
![More endpoints](img/image2.png.png)
...
```yaml
endpoints:
  - name: TrulyNonexistent
    url: "http://nonexistent.subdomain.abcxyz.com"
    interval: 30s
    conditions:
      - "[STATUS] == 200"
```

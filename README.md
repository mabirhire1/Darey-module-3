...
We will go through the understanding and implementation of Docker-based workflows, image creation, container deployment, and Docker Hub integration. It provides hands-on instructions aligned with the learning objectives.
...
```bash
docker pull ubuntu             # Pull the official Ubuntu image
docker search ubuntu           # Search Docker Hub for images
docker images                 # List downloaded images
```

---
![Docker search](img/image.png)
